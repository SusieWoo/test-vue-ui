    ...
    >
      <el-row :gutter="20">
        <el-col :span="20" :offset="1">
          <el-form-item :label="$t('business.telephone.name')" prop="name">
            <el-input v-model="row.name" clearable/>
          </el-form-item>
          <el-form-item v-if="type == 1" :label="$t('business.telephone.series')" prop="carType">
            <el-select
              v-model="row.carType"
              clearable
              placeholder="请选择"
          ...
          <el-form-item :label="$t('business.telephone.phone')" prop="tel">
