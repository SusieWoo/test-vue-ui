  ...
  <div class="vehicle-manage">
    ...
    <el-card class="card-panel">
      <el-form :inline="true" :model="querys">
        ...
        <el-collapse v-model="activeName" accordion class="collapse-select">
          <el-collapse-item title="高级筛选" name="1">
            ...
            <el-form-item label="处理时间">
              <el-date-picker v-model="querys.excuteStart"  class="search-item" type="date" placeholder="选择起始日期"></el-date-picker>
            </el-form-item>
            <el-form-item label="至">
              <el-date-picker v-model="querys.excuteEnd"  class="search-item" type="date" placeholder="选择截止日期"></el-date-picker>
            </el-form-item>
