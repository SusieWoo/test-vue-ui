<template>
  <div class="message-manage">
    <el-tabs v-model="activeType"
             type="card">
      <el-tab-pane :label="$t('route.messagePush')"
                   name="0" />
      <el-tab-pane :label="$t('route.messageSms')"
                   name="1" />
      <el-tab-pane :label="$t('route.messageStatistics')"
                   name="2" />
    </el-tabs>

    <!-- 推送消息 -->
    <div v-if="activeType === '0'" class="pushMsg">
      <!-- 查询条件start -->
    ...
    <!-- 短消息 -->
    <div v-if="activeType === '1'" class="smsMsg">
      <!-- 查询条件start -->
      <el-card class="card-panel">
        <el-form :inline="true"
                 :model="querys"
